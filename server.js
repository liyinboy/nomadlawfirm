...
app.post('/admin/settings', requireAuth, uploadHero.fields([
  { name: 'heroImage', maxCount: 1 }, { name: 'aboutImage', maxCount: 1 },
  { name: 'heroSlide1Image', maxCount: 1 }, { name: 'heroSlide2Image', maxCount: 1 }, { name: 'heroSlide3Image', maxCount: 1 }
]), h(async (req, res) => {
  const {
  ...
  const update = {
    ...
    heroSlide1Caption: heroSlide1Caption || '', heroSlide2Caption: heroSlide2Caption || '', heroSlide3Caption: heroSlide3Caption || ''
  };
